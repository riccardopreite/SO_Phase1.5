...
#define STATUS_INT_UNMASKED 0x0000FF04
#define VM_OFF 0x07000000
#define KM_ON  0x0000002A
#define MASK   0x0900FF04
...
#define DEV_REG_SIZE (DEV_REG_LEN * WORD_SIZE)
...
#define MASK   0x0900FF04
/*  processor Local Timer */
#define STATUS_TE  0x08000000ons are useful to compute the overall space taken
  /* by the OS (see below) */
/* All interrupts unmasked */
#define STATUS_INT_UNMASKED 0x0000FF04
#define VM_OFF 0x07000000
